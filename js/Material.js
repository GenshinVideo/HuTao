...
function SetCharacterList() {
  ...
  S_Id = "Sandrone";
  S_JpName = "サンドローネ";
  S_CharaImg = "Original/Character2/marionettenew_133_gacha_splash.webp";
  S_Element = "Shivada_Jade";
  S_Boss = "Plume_of_the_Fallen_Watcher";
  S_Local = "Etherwing_Moth";
  S_Common = "Frost_Etched_Warrant";
  S_Talent1 = "Vagrancy";
  S_Talent2 = "Madmans_Restraint";
  Checkmate();

  // プルーネ
  S_Id = "Prune";
  S_JpName = "プルーネ";
  S_CharaImg = "Original/Character2/prune_132_gacha_splash.webp";
  ...
  S_Id = "Nicole";
  S_JpName = "ニコ";
  S_CharaImg = "Original/Character2/nicole_131_gacha_splash.webp";
  S_Element = "Agnidus_Agate";
  S_Boss = "Remnant_of_the_Dreadwing";
  S_Local = "Pine_Amber";
  S_Common = "Frost_Etched_Warrant";
  S_Talent1 = "Elysium";
  S_Talent2 = "Counterfeit_Resin";
  Checkmate();
...
function SetCalculatorList() {
  ...
  function SetCalculatorTLUM2() {
    ...
    S_Check_3 = "";
    const allItems = [
      { name: "Profaned_Sprout", unit: " 個" },
      { name: "Twisted_Withered_Branch", unit: " 個" },
      { name: "Counterfeit_Resin", unit: " 個" },
...
function SetPatchNoteList() {
  ...
  CalEle.insertAdjacentHTML(
    "beforeend",
    "\
<b>2026/07/12</b><BR>\
更新。<BR>\
・ニコ、プルーネ、サンドローネの実装に対応<BR>\
<BR>\
既知の問題。<BR>\
...
function Exp_Calculator() {
  ...
  var In_Character_EXP_Material = parseInt(document.getElementById("Heros_Wit").value) * 20000 + parseInt(document.getElementById("Adventurers_Experience").value) * 5000 + parseInt(document.getElementById("Wanderers_Advice").value) * 1000;
...
document.getElementsByClassName("Calculator")[0].addEventListener(
  "click",
  () => {
    Calculator();
  },
